...
/**
 * StateButton-一个可以用代码设置selector背景（按下去背景颜色更改，样式变化等等）的button
 */
public class StateButton extends AppCompatButton {
    ...
    private void setup(AttributeSet attrs) {
        ...
        //get original text color as umeng_push_notification_default_soundsh_notification_default_sound.mp3
        //set text color
