...
public class DriverActivity extends FragmentActivity {
    ...
    private void setListener() {
        mRg_main.setOnCheckedChangeListener(new DriverActivity.MyOnCheckedChangeListener());
        //设置默认选中常用框架
        mRg_main.check(R.id.own);
    }
    ...
    private void initFragment() {
        ...
        mBaseFragment.add(new DriverFragment());//司机主页
        mBaseFragment.add(new StudentFragment());//主界面
    }
